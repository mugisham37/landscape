    ...
    <section class="section_explore">
                <div class="padding-global padding-section-large">
                    <div class="container-large">
                        <div class="explore_content"><a data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff094f0"
                                href="/projects" class="explore_card w-inline-block"><img
                                ...
                                <div class="explore_card-header">
                                    <div data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff094f3" class="badge-wrapper"
                                        ...
                                        <div class="badge">
                                            <div class="badge-text">Our projects<br></div>
                                        </div>
                                    </div>
                                    <div data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff094f7" class="explore_card-title"
                                        style="transform: translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; opacity: 0;">
                                        <h3 class="text-3xl">Your idea, our expertise.</h3>
                                    </div>
                                </div>
                                <div data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff094fa" class="button-wrapper"
                                    style="transform: translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; opacity: 0;">
                                    <div class="button-cicle"
                                        style="will-change: transform; transform: translate3d(0rem, 0rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">
                                        <div class="button-circle_wrapper">
                                            <div class="text-block">Explore more</div>
                                        </div>
                                    </div>
                                </div>
                            </a><a data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff094fd" href="/account/sign-in"
                                class="explore_card w-inline-block"><img
                                    ...
                                    style="transform: translate3d(0px, 0%, 0px) scale3d(1.35, 1.35, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; filter: blur(20px); will-change: transform;">
                                <div class="explore_card-header">
                                    <div data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff09500" class="badge-wrapper"
                                        style="transform: translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; opacity: 0;">
                                        <div class="badge">
                                            <div class="badge-text">Contact us<br></div>
                                        </div>
                                    </div>
                                    <div data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff09504" class="explore_card-title"
                                        style="transform: translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; opacity: 0;">
                                        <h3 class="text-3xl">Let's begin the experience.</h3>
                                    </div>
                                </div>
                                <div data-w-id="42302e83-bbf4-64c0-4f42-be8b8ff09507" class="button-wrapper"
                                    style="transform: translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; opacity: 0;">
                                    <div class="button-cicle"
                                        style="will-change: transform; transform: translate3d(0rem, 0rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">
                                        <div class="button-circle_wrapper">
