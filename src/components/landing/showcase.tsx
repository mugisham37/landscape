                            ...
                            <div className="w-dyn-list">
                                <div role="list" className="showcase_grid w-dyn-items">
                                    <div data-w-id="500da0dd-74e3-ede0-cfe3-640336f10c2f"
                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                        role="listitem" className="w-dyn-item"><a
                                            ...
                                            <div className="showcase_card-header">
                                                <div style={{"borderColor":"rgb(228, 228, 228)"}}
                                                    ...
                                                    <div data-w-id="86ea5708-90c3-90d9-d170-dbbcc59a1b63"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                        className="text-xl">Urban Retreat in Golden Gate Park</div>
                                                ...
                                                <div data-w-id="8ae3e3df-ea8a-ac21-108a-1c4f3eda447c"
                                                    className="showcase_card-visual"><img
                                                        ...
                                                        loading="lazy"
                                                        style={{"transform":"translate3d(0px, 0%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","filter":"blur(20px)","willChange":"transform"}}
                                            ...
                                            <div data-w-id="ab5779b5-a713-53ef-b61e-0c1bb1842f25"
                                                style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                className="text-base text-color-secondary">Golden Gate Park offers
                                                landscapes, museums, and gardens, perfect for walks and picnics.</div>
                                            <div data-w-id="10b8233a-0681-3c9c-c31c-ad21c51a26fc"
                                                style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0","borderColor":"rgb(228, 228, 228)"}}
                                                ...
                                                <div style={{"borderColor":"rgb(228, 228, 228)"}}
                                                    ...
                                                    <div data-w-id="cd16f111-24d1-b655-e9da-e98451020010"
                                                        ...
                                                        className="text-base">Seattle, Washington, United States</div>
                                                </div>
                                                <div className="showcase_card-bottom-content">
                                                    ...
                                                    <div data-w-id="01b0273e-96a7-cb81-9d48-83478b009442"
                                                        style={{"opacity":"0","transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d"}}
                                                        className="text-base">Urbano</div>
                                                </div>
                                            </div>
                                        </a></div>
                                    <div data-w-id="500da0dd-74e3-ede0-cfe3-640336f10c2f"
                                        ...
                                        role="listitem" className="w-dyn-item"><a
                                            data-w-id="ad8eabbf-346b-c293-283c-f6a9352649b0"
                                            href="/projects/grand-conference-hall" className="showcase_card w-inline-block">
                                            <div className="showcase_card-header">
                                                <div style={{"borderColor":"rgb(228, 228, 228)"}}
                                                    className="showcase_card-title-wrap">
                                                    <div data-w-id="86ea5708-90c3-90d9-d170-dbbcc59a1b63"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                        className="text-xl">Grand Conference Hall</div>
                                                    <div data-w-id="c0e52711-77b1-4161-3592-f89107807f4e"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                        className="showcard_card-year-wrap"><img
                                                            src="https://cdn.prod.website-files.com/67463b290def428dc18a7933/674dddf7391111706be28b45_black%20dot.svg"
                                            ...
                                            <div data-w-id="ab5779b5-a713-53ef-b61e-0c1bb1842f25"
                                                style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                className="text-base text-color-secondary">A spacious conference room with
                                            ...
                                            <div data-w-id="10b8233a-0681-3c9c-c31c-ad21c51a26fc"
                                                ...
                                                <div style={{"borderColor":"rgb(228, 228, 228)"}}
                                                    ...
                                                    <div data-w-id="cd16f111-24d1-b655-e9da-e98451020010"
                                                        style={{"opacity":"0","transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d"}}
                                                        className="text-base">Oaklanda, California, United States</div>
                                                </div>
                                                <div className="showcase_card-bottom-content">
                                                    <div data-w-id="01b0273e-96a7-cb81-9d48-83478b00943f"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                    ...
                                                    <div data-w-id="01b0273e-96a7-cb81-9d48-83478b009442"
                                                        style={{"opacity":"0","transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d"}}
                                                        className="text-base">Interior</div>
                                                </div>
                                            </div>
                                        </a></div>
                                    <div data-w-id="500da0dd-74e3-ede0-cfe3-640336f10c2f"
                                        ...
                                        role="listitem" className="w-dyn-item"><a
                                            data-w-id="ad8eabbf-346b-c293-283c-f6a9352649b0"
                                            href="/projects/shopping-center" className="showcase_card w-inline-block">
                                            <div className="showcase_card-header">
                                                <div style={{"borderColor":"rgb(228, 228, 228)"}}
                                                    className="showcase_card-title-wrap">
                                                    <div data-w-id="86ea5708-90c3-90d9-d170-dbbcc59a1b63"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                        className="text-xl">Shopping Center</div>
                                                    <div data-w-id="c0e52711-77b1-4161-3592-f89107807f4e"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                        className="showcard_card-year-wrap"><img
                                                            src="https://cdn.prod.website-files.com/67463b290def428dc18a7933/674dddf7391111706be28b45_black%20dot.svg"
                                            ...
                                            <div data-w-id="ab5779b5-a713-53ef-b61e-0c1bb1842f25"
                                                style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                className="text-base text-color-secondary">A contemporary, light-filled
                                    ...
                                    <div data-w-id="500da0dd-74e3-ede0-cfe3-640336f10c2f"
                                        ...
                                        role="listitem" className="w-dyn-item"><a
                                            data-w-id="ad8eabbf-346b-c293-283c-f6a9352649b0"
                                            href="/projects/sustainable-offices" className="showcase_card w-inline-block">
                                            <div className="showcase_card-header">
                                                <div style={{"borderColor":"rgb(228, 228, 228)"}}
                                                    className="showcase_card-title-wrap">
                                                    <div data-w-id="86ea5708-90c3-90d9-d170-dbbcc59a1b63"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                        className="text-xl">Sustainable Offices</div>
                                                    <div data-w-id="c0e52711-77b1-4161-3592-f89107807f4e"
                                                        style={{"transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d","opacity":"0"}}
                                                        className="showcard_card-year-wrap"><img
                                                            src="https://cdn.prod.website-files.com/67463b290def428dc18a7933/674dddf7391111706be28b45_black%20dot.svg"
                                            ...
                                            <div data-w-id="10b8233a-0681-3c9c-c31c-ad21c51a26fc"
                                                ...
                                                <div className="showcase_card-bottom-content">
                                                    ...
                                                    <div data-w-id="01b0273e-96a7-cb81-9d48-83478b009442"
                                                        style={{"opacity":"0","transform":"translate3d(0px, 15%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)","transformStyle":"preserve-3d"}}
                                                        className="text-base">Corporate</div>
                                                </div>
                                            </div>
                                        </a></div>
                                </div>
